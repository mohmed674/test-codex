    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(
                        ...
                        max_digits=10,
                        null=True,
                        verbose_name="Default Piece Rate",
                    ),
                ),
                (
                    "hourly_rate",
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=8, verbose_name="Default Daily Hours"
                    ),
                ),
                (
                    "is_active",
                ...
                (
                    "visible_on_payroll",
                    models.BooleanField(
                        default=True, verbose_name="Visible on Payroll?"
                    ),
                ),
                (
                    "used_in_sections",
                    django.contrib.postgres.fields.ArrayField(
                        ...
                        null=True,
                        size=None,
                        verbose_name="Used in Sections",
                    ),
                ),
                (
                    "linked_to_production_stage",
                    models.CharField(
                        blank=True,
                        max_length=100,
                        null=True,
                        verbose_name="Linked to Production Stage",
                    ),
                ),
                (
                    "created_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_bulk_unit",
                    models.BooleanField(default=False, verbose_name="Is Bulk Unit?"),
                ),
                (
                    "conversion_factor",
                    models.FloatField(
                        blank=True, null=True, verbose_name="Conversion Factor"
                    ),
                ),
                (
                    "used_in_models",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "section",
                    models.CharField(
                        blank=True, max_length=100, null=True, verbose_name="Section"
                    ),
                ),
                (
                    "granted_by",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "response_reason",
                    models.TextField(
                        blank=True, null=True, verbose_name="Response Reason"
                    ),
                ),
                (
                    "reviewed_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "risk_type",
                    models.CharField(max_length=100, verbose_name="Risk Type"),
                ),
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=100,
                        null=True,
                        verbose_name="Applies to Section",
                    ),
                ),
                (
                    "auto_detected_field",
                    models.CharField(
                        ...
                        max_length=100,
                        null=True,
                        verbose_name="Auto Detected Field",
                    ),
                ),
                (
                    "action_required",
                    models.TextField(
                        blank=True, null=True, verbose_name="Action Required"
                    ),
                ),
                (
                    "trigger_auto_action",
                    models.BooleanField(
                        default=False, verbose_name="Trigger Auto Action?"
                    ),
                ),
                (
                    "is_active",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "requires_machine",
                    models.BooleanField(
                        default=False, verbose_name="Requires Machine?"
                    ),
                ),
                (
                    "created_at",
                ...
                (
                    ...
                    models.ManyToManyField(
                        ...
                        to="core.jobtitle",
                        verbose_name="Linked Job Titles",
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "can_read",
                    models.BooleanField(default=True, verbose_name="Can Read?"),
                ),
                (
                    "can_update",
                    models.BooleanField(default=False, verbose_name="Can Update?"),
                ),
                (
                    "can_delete",
                ...
                (
                    "override_reason",
                    models.TextField(
                        blank=True, null=True, verbose_name="Override Reason"
                    ),
                ),
                (
                    "created_at",
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=100,
                        null=True,
                        verbose_name="Applies to Department",
                    ),
                ),
                (
                    "is_active",
