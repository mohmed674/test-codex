...
urlpatterns = [
    ...
    path(
        "admin-dashboard/pdf/",
        views.admin_dashboard_pdf_view,
        name="admin_dashboard_pdf",
    ),
    # 🧾 الوظائف (Job Titles)
    ...
    path(
        "job-titles/<int:pk>/delete/", views.job_title_delete, name="job_title_delete"
    ),
    # 📏 الوحدات (Units)
    ...
    path(
        "evaluation-criteria/<int:pk>/edit/",
        views.criteria_update,
        name="criteria_update",
    ),
    path(
        "evaluation-criteria/<int:pk>/delete/",
    ...
    path(
        "stage-types/<int:pk>/edit/", views.stage_type_update, name="stage_type_update"
    ),
    path(
        "stage-types/<int:pk>/delete/",
        views.stage_type_delete,
        name="stage_type_delete",
    ),
    # ⚠️ حدود المخاطر (Risk Thresholds)
    path("risk-thresholds/", views.risk_threshold_list, name="risk_threshold_list"),
    path(
        "risk-thresholds/create/",
        views.risk_threshold_create,
        name="risk_threshold_create",
    ),
    path(
        "risk-thresholds/<int:pk>/edit/",
        views.risk_threshold_update,
        name="risk_threshold_update",
    ),
    path(
        "risk-thresholds/<int:pk>/delete/",
        views.risk_threshold_delete,
    ...
    path(
        ...
        views.department_role_create,
        name="department_role_create",
    ),
    path(
        "department-roles/<int:pk>/edit/",
        views.department_role_update,
        name="department_role_update",
    ),
    path(
        "department-roles/<int:pk>/delete/",
        views.department_role_delete,
        name="department_role_delete",
    ),
    ...
    path(
        "offline.html",
        TemplateView.as_view(template_name="core/offline.html"),
        name="offline",
    ),
