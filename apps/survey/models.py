...
class SurveyQuestion(models.Model):
    ...
    question_text = models.CharField(
        max_length=255, verbose_name="نص السؤال", blank=True, default=""
    )
    question_type = models.CharField(
        max_length=20, choices=QUESTION_TYPES, verbose_name="نوع السؤال"
    )
...
class SurveyChoice(models.Model):
    ...
    choice_text = models.CharField(
        max_length=255, verbose_name="الاختيار", blank=True, default=""
    )
...
class SurveyResponse(models.Model):
    survey = models.ForeignKey(
        Survey, on_delete=models.CASCADE, verbose_name="الاستبيان"
    )
...
class Answer(models.Model):
    ...
    question = models.ForeignKey(
        SurveyQuestion, on_delete=models.CASCADE, verbose_name="السؤال"
    )
    ...
    rating = models.PositiveSmallIntegerField(
        blank=True, null=True, verbose_name="التقييم (إن وجد)"
    )
