...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        stagnant_items = InventoryItem.objects.filter(
            last_movement_date__lt=threshold_date
        )
        ...
        critical_items = InventoryItem.objects.filter(
            quantity__lt=10
        )  # الحد يمكن تعديله من الإعدادات لاحقًا
        ...
        self.stdout.write(
            self.style.SUCCESS("✅ تم تحليل المخزون وتنبيه الأصناف الحرجة والراكدة.")
        )
