...
from .api_views import (BomLineViewSet, BomViewSet, ChangeRequestItemViewSet,
                        ChangeRequestViewSet, LifecycleStageViewSet,
                        PLMDocumentViewSet, ProductLifecycleViewSet,
                        ProductTemplateViewSet, ProductVersionViewSet)
...
router.register(
    r"change-request-items", ChangeRequestItemViewSet, basename="plm-changerequestitem"
)
