    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, related_name="product_versions", to="plm.plmdocument"
            ),
        ),
        migrations.AddField(
            model_name="productversion",
        ...
        migrations.AddField(
            ...
            name="attachments",
            field=models.ManyToManyField(
                blank=True, related_name="change_requests", to="plm.plmdocument"
            ),
        ),
        migrations.AddField(
            model_name="changerequest",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT,
                related_name="as_component_in_boms",
                to="plm.producttemplate",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddIndex(
            model_name="productversion",
            index=models.Index(
                fields=["version_code"], name="plm_product_version_2dab10_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="productversion",
        ...
        migrations.AddIndex(
            model_name="productversion",
            index=models.Index(
                fields=["is_active"], name="plm_product_is_acti_2136e4_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            model_name="changerequest",
            index=models.Index(
                fields=["change_type"], name="plm_changer_change__56c7b7_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="bom",
