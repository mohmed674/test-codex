    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        blank=True,
                        null=True,
                        upload_to="patterns/gerber/",
                        verbose_name="ملف Gerber",
                    ),
                ),
                (
                    "pattern_type",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "fabric_type",
                    models.CharField(max_length=100, verbose_name="نوع القماش"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "operator_name",
                    models.CharField(max_length=100, verbose_name="اسم منفذ الباترون"),
                ),
                (
                    "design",
                    models.ForeignKey(
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="executed_patterns",
