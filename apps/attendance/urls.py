...
from . import views
from .reports import \
    attendance_reports as report_views  # ✅ تحديث المسار الجديد
...
urlpatterns = [
    ...
    path(
        "report/pdf/", report_views.attendance_report_pdf, name="attendance_report_pdf"
    ),
    path(
        "report/excel/",
        report_views.attendance_report_excel,
