...
from .forms import (PurchaseInvoiceForm, PurchaseItemFormSet,
                    PurchaseOrderForm, PurchaseRequestForm)
...
def purchase_request_create(request):
    ...
    return render(
        request,
        "purchases/purchase_request_form.html",
...
def purchase_order_create(request, request_id):
    ...
    return render(
        ...
        {"form": form, "purchase_request": purchase_request},
    )
...
def purchase_invoice_create(request, order_id):
    ...
    return render(
        request, "purchases/purchase_invoice_form.html", {"form": form, "order": order}
    )
