...
urlpatterns = [
    ...
    path(
        "calculate-daily-pay/<int:employee_id>/",
        views.calculate_daily_payment,
        name="calculate_daily_pay",
    ),
    path("salaries/", views.salary_list, name="salary_list"),
    path("report/salaries/", report_views.salary_report, name="salary_report"),
    # ✅ مسار إدارة اللائحة
    path(
        "policy-settings/", views.manage_policy_settings, name="manage_policy_settings"
    ),
