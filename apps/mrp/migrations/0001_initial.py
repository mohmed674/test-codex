...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=3,
                        default=Decimal("0.000"),
                        help_text="يُحسب = المطلوب − (المتاح − المحجوز) ولا يقل عن صفر.",
                        max_digits=16,
                        validators=[
                            django.core.validators.MinValueValidator(Decimal("0.000"))
                        ],
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(
                        ...
                        verbose_name="الكمية المخطط لها",
                    ),
                ),
                (
                    "uom_code",
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("MPS", "جدولة الإنتاج الرئيسي"),
                            ("MANUAL", "يدوي"),
                        ],
                        default="MRP",
                        max_length=10,
                        verbose_name="نوع التخطيط",
                    ),
                ),
                (
                    "status",
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        default=2, verbose_name="الأولوية"
                    ),
                ),
                (
                    "version",
                    models.PositiveIntegerField(default=1, verbose_name="الإصدار"),
                ),
                (
                    "demand_source",
                    models.CharField(
                ...
                (
                    "auto_generated",
                    models.BooleanField(default=False, verbose_name="مولّد تلقائيًا"),
                ),
                (
                    "created_at",
                    models.DateTimeField(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        default="",
                        max_length=128,
                        verbose_name="مورد مُقترح (اختياري)",
                    ),
                ),
                (
                    "status",
                    models.CharField(
                        ...
                        default="DRAFT",
                        max_length=12,
                        verbose_name="حالة الاقتراح",
                    ),
                ),
                (
                    "auto_generated",
                    models.BooleanField(default=True, verbose_name="مولَّد تلقائيًا"),
                ),
                (
                    "notes",
                    models.TextField(blank=True, default="", verbose_name="ملاحظات"),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="mrp_procure_status_4e4a2e_idx",
                    )
                ],
            },
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["status", "required_date"], name="mrp_materia_status_a83586_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="materialplanning",
            index=models.Index(
                fields=["product", "required_date"],
                name="mrp_materia_product_ecac82_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="materialline",
            index=models.Index(
                fields=["material"], name="mrp_materia_materia_437fa2_idx"
            ),
        ),
