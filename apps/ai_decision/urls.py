...
from .views import (ai_dashboard, ai_report_csv, ai_report_excel,
                    ai_report_pdf, ai_reports_dashboard,
                    ai_sales_analysis_report, analyze_decision, copilot_query,
                    copilot_view, decision_history_view, decision_report)
from .views_future import (ai_decision_assistant_api, ai_learning_dashboard,
                           ai_predictive_analysis, ai_visual_dashboard)
...
urlpatterns = [
    ...
    path(
        "create/", analyze_decision, name="create"
    ),  # mapping analyze as "create decision"
    path(
        "detail/<int:pk>/", decision_report, name="detail"
    ),  # can expand with pk later
    path(
        "update/<int:pk>/", analyze_decision, name="update"
    ),  # placeholder for consistency
    path(
        "delete/<int:pk>/", decision_report, name="delete"
    ),  # placeholder for consistency
    # Dashboards
