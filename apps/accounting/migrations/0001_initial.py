    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "timestamp",
                    models.DateTimeField(auto_now_add=True, verbose_name="الزمن"),
                ),
                (
                    "suggested_by_ai",
                    models.BooleanField(
                        default=True, verbose_name="مُقترح بواسطة الذكاء الاصطناعي؟"
                    ),
                ),
                (
                    "suggestion_type",
                    models.CharField(
                        db_index=True, max_length=100, verbose_name="نوع الاقتراح"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "purchase_date",
                    models.DateField(
                        default=django.utils.timezone.now, verbose_name="تاريخ الشراء"
                    ),
                ),
                (
                    "value",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "product_name",
                    models.CharField(
                        db_index=True, max_length=255, verbose_name="اسم المنتج"
                    ),
                ),
                (
                    "components_json",
                    models.TextField(
                        blank=True, null=True, verbose_name="المكوّنات (JSON)"
                    ),
                ),
                (
                    "total_cost",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        db_index=True, max_length=255, verbose_name="اسم العميل"
                    ),
                ),
                (
                    "phone",
                ...
                (
                    "governorate",
                    models.CharField(
                        blank=True, max_length=100, null=True, verbose_name="المحافظة"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=100, unique=True, verbose_name="اسم طريقة الدفع"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "reference",
                    models.CharField(
                        blank=True, max_length=100, null=True, verbose_name="مرجع"
                    ),
                ),
                (
                    "note",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        db_index=True, max_length=255, verbose_name="اسم المورد"
                    ),
                ),
                (
                    "phone",
        ...
        migrations.AddIndex(
            model_name="expense",
            index=models.Index(
                fields=["category"], name="accounting__categor_2b41ab_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="customer",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["product_name"], name="accounting__product_278ab9_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="asset",
            index=models.Index(
                fields=["asset_type"], name="accounting__asset_t_b1afd5_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="asset",
            index=models.Index(
                fields=["is_active"], name="accounting__is_acti_742660_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="accountingsuggestionlog",
            index=models.Index(
                fields=["timestamp"], name="accounting__timesta_18602b_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="accountingsuggestionlog",
            index=models.Index(
                fields=["risk_level"], name="accounting__risk_le_8be360_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="accountingsuggestionlog",
            index=models.Index(
                fields=["resolved"], name="accounting__resolve_6e4008_idx"
            ),
        ),
        migrations.AddField(
            model_name="account",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["date_issued"], name="accounting__date_is_b0512d_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="supplierinvoice",
        ...
        migrations.AddIndex(
            model_name="salesinvoice",
            index=models.Index(
                fields=["date_issued"], name="accounting__date_is_c9f88b_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="salesinvoice",
        ...
        migrations.AddIndex(
            model_name="purchaseinvoice",
            index=models.Index(
                fields=["date_issued"], name="accounting__date_is_9f81fc_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="purchaseinvoice",
        ...
        migrations.AddIndex(
            model_name="paymentorder",
            index=models.Index(
                fields=["payment_date"], name="accounting__payment_7efc46_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="paymentorder",
            index=models.Index(
                fields=["payment_method"], name="accounting__payment_675752_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="payment",
        ...
        migrations.AddIndex(
            model_name="manufacturingorder",
            index=models.Index(
                fields=["start_date"], name="accounting__start_d_59d110_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="journalentry",
        ...
        migrations.AddIndex(
            model_name="invoice",
            index=models.Index(
                fields=["date_issued"], name="accounting__date_is_c42645_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="invoice",
            index=models.Index(
                fields=["due_date"], name="accounting__due_dat_cfd46e_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="invoice",
