...
from .models import (AccountingSuggestionLog, Customer, JournalEntry,
                     JournalItem, Supplier, SupplierInvoice)
...
def financial_analysis_view(request):
    monthly_data = (
        JournalEntry.objects.annotate(month=TruncMonth("date"))
    ...
    return render(request, "accounting/financial_analysis.html", {"analysis": analysis})
...
def journal_dashboard(request):
    ...
    return render(
        request, "accounting/journal/journal_dashboard.html", {"entries": entries}
    )
...
def journal_detail(request, pk):
    ...
    return render(
        request,
        "accounting/journal/journal_detail.html",
        {"entry": entry, "items": items},
    )
...
def supplier_list(request):
    ...
    return render(
        request, "accounting/partners/supplier_list.html", {"suppliers": suppliers}
    )
...
def customer_list(request):
    ...
    return render(
        request, "accounting/partners/customer_list.html", {"customers": customers}
    )
...
def product_list(request):
    ...
    return render(
        request, "accounting/products/product_list.html", {"products": products}
    )
...
def guided_journal_entry_view(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            if entry:
                messages.success(
                    request, "✅ تم تسجيل القيد تلقائيًا باستخدام الذكاء الاصطناعي."
                )
...
def suggestion_log_view(request):
    ...
    return render(
        request, "accounting/suggestion_log.html", {"suggestions": suggestions}
    )
