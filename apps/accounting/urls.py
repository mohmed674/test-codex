...
from . import invoice_views, views
...
urlpatterns = [
    ...
    # ========== فواتير المبيعات ==========
    path(
        "sales/create/", invoice_views.create_sales_invoice, name="create_sales_invoice"
    ),
    path(
        "sales/<int:pk>/",
        invoice_views.sales_invoice_detail,
        name="sales_invoice_detail",
    ),
    path(
        "sales/", invoice_views.sales_invoice_dashboard, name="sales_invoice_dashboard"
    ),
    path(
        "sales/export/excel/",
        invoice_views.sales_invoice_excel,
        name="sales_invoice_excel",
    ),
    # ========== فواتير المشتريات ==========
    path(
        "purchase/create/",
        invoice_views.create_purchase_invoice,
        name="create_purchase_invoice",
    ),
    path(
        "purchase/<int:pk>/",
        invoice_views.purchase_invoice_detail,
        name="purchase_invoice_detail",
    ),
    # ========== طباعة PDF ==========
    path(
        "invoice/<str:invoice_type>/<int:pk>/print/",
        invoice_views.print_invoice_pdf,
        name="print_invoice_pdf",
    ),
    # ========== قيود اليومية ==========
    ...
    path(
        "journal/ai/create/",
        views.journal_entry_create_view,
    ...
    path(
        "products/",
        RedirectView.as_view(url="/products/", permanent=True, query_string=True),
        name="product_list",
    ),
    path(
        "products/create/",
        RedirectView.as_view(
            url="/products/create/", permanent=True, query_string=True
        ),
        name="product_create",
    ),
    # ========== تقارير وتصدير عام ==========
    path(
        "export/excel/", views.export_accounting_excel, name="export_accounting_excel"
    ),
    ...
    path(
        ...
        payments_by_method_report,
        name="payments_by_method_report",
    ),
    path(
        "analysis/financial/", views.financial_analysis_view, name="financial_analysis"
    ),
    # ========== ذكاء محاسبي ==========
